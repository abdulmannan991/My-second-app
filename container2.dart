        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              ...
              style: TextStyle(
                  ...
                  fontSize: 25,
                  color: Color.fromARGB(255, 80, 169, 83)),
            ),
          ),
          Container(
            ...
            child: Text(
              "30 Day Package",
              style: TextStyle(color: Color.fromARGB(255, 80, 169, 83)),
            ),
          ),
          Container(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                      ...
                      primary: Color.fromARGB(255, 78, 199, 118)),
                  onPressed: () {
          ...
          Container(
            ...
            child: Text(
              "onnet mins",
              style: TextStyle(
                  fontSize: 10, color: Color.fromARGB(255, 80, 169, 83)),
            ),
          ),
          Container(
          ...
          Container(
            ...
            child: Text(
              "7000",
              style: TextStyle(
                  fontSize: 15, color: Color.fromARGB(255, 80, 169, 83)),
            ),
          ),
          Container(
